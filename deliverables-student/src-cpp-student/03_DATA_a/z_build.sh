...
clang++ ${CPPFLAGS} -I${HEADER_PATH}/helpers/  -c z_limits_println.cpp
clang++ ${CPPFLAGS} -I${HEADER_PATH}/helpers/  -c z_printlnDemo.cpp
...
clang++ -o a.out_z_limits z_limits_println.o
clang++ -o a.out_z_printlnDemo z_printlnDemo.o
