...
#clang++ ${CPPFLAGS} -I${HEADER_PATH}/helpers/ -c z_main_mp4_OO_a_vehicles.cpp
clang++ ${CPPFLAGS} -I${HEADER_PATH}/helpers/ -c z_main_value_entity.cpp
...
#clang++ -o a.out_z_vehicles z_main_mp4_OO_a_vehicles.o
