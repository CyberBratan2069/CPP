...
clang++ ${CPPFLAGS} -I${HEADER_PATH}/helpers/ -c mods.cpp AnsiConsole.cpp printSteps.cpp -o mods
clang++ ${CPPFLAGS} -I${HEADER_PATH}/helpers/ mods.cpp AnsiConsole.cpp printSteps.cpp -o mods
